...
public class PopularCountryAdapter extends RecyclerView.Adapter<PopularCountryAdapter.MyViewHolder> {
    ...
    public PopularCountryAdapter(Context context, List<ResponseBean> list, String cameFrom, LagaugeAdded listner)
    {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
       ...
       return new PopularCountryAdapter.MyViewHolder(binding);
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        if(list.get(position).isChecked()) { holder.binding.mainCl.setBackgroundTintList(context.getColorStateList(R.color.darkPurple));
            ...
            holder.binding.mainCl.setBackgroundTintList(context.getColorStateList(android.R.color.transparent));
